...
var RangeBuilder = require('./range')
 ...
 * @return {Promise}
 */
Client.prototype.merge = function (collection, key, data) {
  assert(collection && key && data, 'Collection, key and JSON object required.')
 ...
 * @return {Promise}
 */
Client.prototype.patch = function (collection, key, patchOps) {
...
/**
 * Create new range builder.
 * @return {RangeBuilder}
 */
Client.prototype.newRangeBuilder = function() {
