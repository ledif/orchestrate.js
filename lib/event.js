 ...
 * @return {EventBuilder}
 */
EventBuilder.prototype.beforeEvent = function (beforeEvent) {
  assert(beforeEvent, 'beforeEvent required.')
  this.beforeTime = beforeEvent
  return this
}
 ...
 * @return {EventBuilder}
 */
EventBuilder.prototype.afterEvent = function (afterEvent) {
  assert(afterEvent, 'afterEvent required.')
  this.afterTime = afterEvent
  return this
}
