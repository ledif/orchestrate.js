...
SearchBuilder.prototype.aggregates = function(aggregateBuilder) {
  ...
  var _aggregate = aggregateBuilder.toQString()
  if (this._aggregates) this._aggregates = [this._aggregates, _aggregate].join(',')
  else this_aggregates = _aggregate
  return this
}
